 ...
 */
final class Version20240414124040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE credit CHANGE id_user id_user INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE credit CHANGE id_user id_user INT NOT NULL');
